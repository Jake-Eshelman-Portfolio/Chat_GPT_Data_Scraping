...
tk.Label(root, text="Important Notes: (optional)").grid(row=3, column=0, sticky=tk.W)
important_entry = tk.Text(root, height=3, width=50, wrap="word")
important_entry.grid(row=3, column=1, padx=10, pady=5)
...
# Result Text Field
tk.Label(root, text="Generated Prompt:").grid(row=5, column=0, sticky=tk.W)
